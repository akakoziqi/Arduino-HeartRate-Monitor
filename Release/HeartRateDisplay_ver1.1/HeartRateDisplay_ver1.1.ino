...
void displayBeat() {
  ...
  display.drawBitmap(0, 21, boom, 32, 32, WHITE);    //Draw the second picture (bigger heart)
...
void displayNoBeat() {
  ...
  display.drawBitmap(54, 0, str_6, 16, 16, 1);
  display.drawBitmap(70, 0, str_7, 16, 16, 1);
  display.drawBitmap(5, 26, noboom, 24, 21, WHITE);       //Draw the first bmp picture (little heart)
